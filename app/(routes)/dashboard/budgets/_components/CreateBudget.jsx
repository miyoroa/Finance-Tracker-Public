      ...
      <Dialog>
        <DialogTrigger asChild>
          ...
          >
            ...
            <h2 className="text-gray-900 dark:text-white">Create New Budget</h2>
          </div>
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              <div className="mt-5">
                ...
                <div className="mt-2">
                  <h2 className="text-gray-900 dark:text-white font-medium my-1">Budget Name</h2>
                  <Input
                ...
                <div className="mt-2">
                  <h2 className="text-gray-900 dark:text-white font-medium my-1">Budget Amount</h2>
                  <Input
                    type="number"
